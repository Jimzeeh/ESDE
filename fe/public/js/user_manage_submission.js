        ...
        axios({
            ...
            .then(function(response) {
                ...
                for (let index = 0; index < records.length; index++) {
                    ...
                    $editDesignButtonBlock.append($('<a>Update</a>').addClass('btn btn-primary').attr('href', 'update_design.html').click(function() {localStorage.setItem('fileId',record.file_id)}));        
